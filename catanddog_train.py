...
data_dir = '/workspace/gradio_experiment_1/flagged/data_catanddog_train/cats_and_dogs_filtered'
...
#FROM HERE LAST LINEAR LAYER ARE GETTING TRAINED, this the code for transfer learning where only last linaer layer gets trained#
...
#save model
#torch.save(model_conv,"type your path" )
